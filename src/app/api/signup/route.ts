...
<body style="margin:0;padding:0;background-color:#2C2420;font-family:'Inter',system-ui,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="background-color:#362E29;border:1px solid rgba(245,237,227,0.07);border-radius:16px;padding:40px 32px;">
      ...
      <p style="color:#A69888;font-size:15px;line-height:1.7;margin:0 0 32px 0;">
      ...
      <div style="text-align:center;margin-bottom:8px;">
        <a href="https://briella.health/login" style="display:inline-block;background-color:#6B8B6F;color:#ffffff;font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;text-decoration:none;padding:14px 32px;border-radius:8px;">
