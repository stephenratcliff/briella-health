...
export default function Home() {
  ...
  const peopleCards = [
    { src: 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?w=600&h=400&fit=crop&q=80', alt: 'Health optimizer', title: 'Health Optimizers', description: 'You track your fitness, nutrition, and sleep — but have limited insight into what\'s actually happening inside your body.' },
    { src: 'https://images.unsplash.com/photo-1581579438747-1dc8d17bbce4?w=600&h=400&fit=crop&q=80', alt: 'Family-focused adults', title: 'Family-Focused Adults', description: 'You have people counting on you. Annual comprehensive testing gives you the data to catch problems early — before they become serious.' },
    { src: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=600&h=400&fit=crop&q=80', alt: 'Longevity-minded', title: 'Longevity-Minded', description: 'You\'ve read the research. You understand that early detection and longitudinal data are the foundation of preventive health.' },
    { src: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=600&h=400&fit=crop&q=80', alt: 'Busy professional', title: 'Busy Professionals', description: 'You don\'t have time for multiple doctor visits and insurance paperwork. One membership, one blood draw, complete picture.' },
    { src: 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=600&h=400&fit=crop&q=80', alt: 'Frustrated patients', title: 'Frustrated Patients', description: 'Your doctor says everything looks "normal" — but you know something\'s off. We test what standard panels miss.' },
    { src: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&h=400&fit=crop&q=80', alt: 'Practice partners', title: 'Practice & Wellness Partners', description: 'Offer your clients comprehensive health testing as a natural extension of your services. Partner pricing available.' },
  ];
